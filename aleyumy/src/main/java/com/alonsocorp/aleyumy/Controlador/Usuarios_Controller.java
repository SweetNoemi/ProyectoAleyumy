...
public class Usuarios_Controller {
    ...
    @PostMapping("/agregar")
    public String agregar(@ModelAttribute Usuarios usuario, RedirectAttributes redirectAttrs) {
    ...
    public String iniciarSesion(@RequestParam String correo,
        ...
        Usuarios usuario = usuariosServicio.validarCredenciales(correo, contrasena);
    ...
    public String validarTokenLogin(@RequestParam String token,
        ...
        Usuarios usuario = usuariosServicio.validarTokenLogin(token);
  ...
  // ============================================
    ...
    public String mostrarTabla(Model modelo) {
        List<Usuarios> lista = usuariosServicio.listar();
    ...
    public String buscar(@RequestParam Integer id, Model modelo) {
        ...
        Optional<Usuarios> usuario = usuariosServicio.buscarPorId(id);
    ...
    public String validarTokenRecuperar(@RequestParam String token,
        ...
        Usuarios usuario = usuariosServicio.validarTokenRecuperar(token);
